...
#Client.py 2001:1:1:1:0:0000:0003:0002 42006  50 /home/deba/Desktop/Top-K-Path/testAndMeasurement/TEST_RESULTS/WebSearchWorkLoad_load_factor_1.0/2001:1:1:1:0:0000:0002:0001_32006_2001:1:1:1:0:0000:0003:0002_42006 120.93081559520444 18 8192
...
try:
    ...
    PACKETS_TO_SEND = ((float(sys.argv[3]))*1024)/BIT_RATE
    logger.info("BIT_RATE "+str(BIT_RATE))
    logger.info("Flow size  "+str(BIT_RATE))
