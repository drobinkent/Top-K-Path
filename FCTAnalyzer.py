...
def getPercentileFCTByFolder(folderName):
    ...
    for f in flowTypeVsFCTMap:
        ...
        totalOfFlowSizeMultipliedByAvgFct = totalOfFlowSizeMultipliedByAvgFct + ( float(f) * np.percentile(flowTypeVsFCTMap.get(f),75))
        print(str(f) + " -- ",np.percentile(flowTypeVsFCTMap.get(f),75))
...
# print("Algorithms Nanme : P4KP ")
# getPercentileFCTByFolder("/home/deba/Desktop/Top-K-Path/testAndMeasurement/TEST_RESULTS/WebSearchWorkLoad_load_factor_0.7")
# print("Algorithms Nanme : ECMP ")
...
# print("Algorithms Nanme : ECMP ")
# getPercentileFCTByFolder("/home/deba/Desktop/Top-K-Path/testAndMeasurement/TEST_RESULTS/WebSearchWorkLoad_load_factor_0.4")
