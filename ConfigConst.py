...
STATISTICS_PULLING_INTERVAL = 0.25# This means after each STATISTICS_PULLING_INTERVAL second controller will wake up the StatisticsPuller thread and collect stats from the switches
...
FLOW_TYPE_BITRATE= [ 12288, 12288, 10240]
